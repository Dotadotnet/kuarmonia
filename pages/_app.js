  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      let function_edite = () => {
        ...
        let input_email = document.querySelector(
          "div.cc-1no03 input[name~=message_field_identity-email]"
        );
        ...
        if (width_doc < 768) {
          ...
          let style =
            ...
            String(margin_right) +
            "px " +
            "!important; bottom : 35px !important";
          if (chat) {
          ...
          let style =
            ...
            "50px" +
            "px " +
            "!important; bottom : 25px !important";
          if (chat) {
            chat.setAttribute("style", style);
          }
        }
